...
?>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <input type="password" name="u_pass" class="form-control"  value="<?php echo $user_pass;?>" required>
                                    <small class="text-muted"></small>
                                </div>
                            </div>
                            <!-- /end password -->
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <input type="date" name="u_birthday" class="form-control" value="<?php echo $user_birthday;?>" disabled>
                                    <small class="text-muted"></small>
                                </div>
                            </div>
                            <!-- /end birthday -->
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <select  class="form-control" name="u_country" disabled="disabled">
                                        <option selected="selected"><?php echo $user_country;?></option>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <input type="file" name="u_image" class="form-control" required>
                                    <small class="text-muted"></small>
                                </div>
                            </div>
                            <!-- /end image -->
...
?>
                        ...
                        <!--user details-->
                        <div  id="user datils" class="col-lg-3" >
 <?php member();?>
                        </div>
                        <!--user details end-->
                    </div>
